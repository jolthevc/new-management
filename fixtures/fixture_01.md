# Fixture 01: Route-based home service

Status: Not run

## Purpose

Stress revenue durability, habit-held recurrence, route density, labor utilization, and whether positive hidden value can be explained as rigorously as risk.
